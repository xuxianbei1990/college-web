package college.framework.xss.config;

import college.framework.enums.WebFilterOrderEnum;
import college.framework.xss.core.clean.JsoupXssCleaner;
import college.framework.xss.core.clean.XssCleaner;
import college.framework.xss.core.filter.XssFilter;
import college.framework.xss.core.json.XssStringJsonDeserializer;
...
import static college.framework.web.config.MyWebAutoConfiguration.createFilterBean;
